...
const Banner = () => {
  return (
    <section className="relative h-screen overflow-hidden md:pt-12">
      ...
      />
      <div className="absolute w-[80%] md:w-full top-[50%] md:top-[50%] -translate-y-[50%] left-[50%] -translate-x-[50%] text-center flex flex-col gap-4 md:gap-6 z-10">
        <CopyElement delay={0.5} animateOnScroll={false}>
          <h1 className="text-white text-[4.8rem] md:text-[9rem] leading-[4.2rem] md:leading-[8.2rem] font-medium tracking-[-.15rem] w-full">
